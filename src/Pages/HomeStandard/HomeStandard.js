            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="banner-category">
                        <div class="banner-category-head"><i class="fas fa-bars"></i><span>categories</span></div>
                    ...
                    <div class="row">
                            ...
                            <div class="home-grid-slider slider-dots">
                                <div class="banner-wrap bg1">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="banner-image"><img src={require('../../images/home/index/01.png')} alt=""/></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="banner-wrap bg2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="banner-image"><img src={require('../../images/home/index/02.png')} alt=""/></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="banner-wrap bg3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            <div class="banner-image"><img src={require('../../images/home/index/03.png')} alt=""/></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="banner-promo">
                                <a href="#"><img src={require('../../images/promo/home/04.jpg')} alt="promo"/></a>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                            <div class="banner-promo">
                                <a href="#"><img src={require('../../images/promo/home/05.jpg')} alt="promo"/></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-4">
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label"><label class="label-text off">-5%</label><label class="label-text new">new</label></div><button class="product-wish wish"><i class="fas fa-heart"></i></button>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label"><label class="label-text off">-20%</label></div><button class="product-wish wish"><i class="fas fa-heart"></i></button>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label"><label class="label-text off">-35%</label></div><button class="product-wish wish"><i class="fas fa-heart"></i></button>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label"><label class="label-text off">-15%</label></div><button class="product-wish wish"><i class="fas fa-heart"></i></button>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label"><label class="label-text off">-18%</label></div><button class="product-wish wish"><i class="fas fa-heart"></i></button>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label"><label class="label-text off">-30%</label></div><button class="product-wish wish"><i class="fas fa-heart"></i></button>
                ...
                <div class="col">
                    <div class="product-card">
                        <div class="product-media">
                            <div class="product-label"><label class="label-text off">-25%</label></div><button class="product-wish wish"><i class="fas fa-heart"></i></button>
            ...
            <div class="tab-pane active" id="top-sales">
                <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                    <div class="col">
                        <div class="product-card">
                            <div class="product-media">
                                <div class="product-label"><label class="label-text sale">314</label></div><button class="product-wish wish"><i class="fas fa-heart"></i></button>
                                <a class="product-image" href="product-video.html"><img src={require('../../images/product/01.jpg')} alt="product"/></a>
                                <div class="product-widget">
                                    <a title="Product Compare" href="compare.html" class="fas fa-random"></a>
                                    <a title="Product Video" href="https://youtu.be/9xzcVxSBbG8" class="venobox fas fa-play" data-autoplay="true" data-vbtype="video"></a>
                ...
                <div class="col-lg-12">
                    <div class="category-slider slider-arrow">
                        <div class="category-wrap">
                            <div class="category-media"><img src={require('../../images/category/dairy.jpg')} alt="category"/>
                                <div class="category-overlay"><a href="#"><i class="fas fa-link"></i></a></div>
                            </div>
                        ...
                        <div class="category-wrap">
                            <div class="category-media"><img src={require('../../images/category/vegetables.jpg')} alt="category"/>
                                <div class="category-overlay"><a href="#"><i class="fas fa-link"></i></a></div>
                            </div>
                            <div class="category-meta">
                        ...
                        <div class="category-wrap">
                            <div class="category-media"><img src={require('../../images/category/drinks.jpg')} alt="category"/>
                                <div class="category-overlay"><a href="#"><i class="fas fa-link"></i></a></div>
                            </div>
                            <div class="category-meta">
                                <h4>coffe & drinks</h4>
                        ...
                        <div class="category-wrap">
                            <div class="category-media"><img src={require('../../images/category/fish.jpg')} alt="category"/>
                                <div class="category-overlay"><a href="#"><i class="fas fa-link"></i></a></div>
                            </div>
                            <div class="category-meta">
                                <h4>fish items</h4>
                        ...
                        <div class="category-wrap">
                            <div class="category-media"><img src={require('../../images/category/groceries.jpg')} alt="category"/>
                                <div class="category-overlay"><a href="#"><i class="fas fa-link"></i></a></div>
                            </div>
                            <div class="category-meta">
                                <h4>grocery items</h4>
                        ...
                        <div class="category-wrap">
                            <div class="category-media"><img src={require('../../images/category/meat.jpg')} alt="category"/>
                                <div class="category-overlay"><a href="#"><i class="fas fa-link"></i></a></div>
                            </div>
                            <div class="category-meta">
                                <h4>meat items</h4>
