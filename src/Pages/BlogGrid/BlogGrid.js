                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="top-filter">
                                ...
                                <div class="filter-short"><label class="filter-label">Short by :</label><select class="form-select filter-select"><option selected>default</option><option value="3">recent</option><option value="1">featured</option><option value="2">recommend</option></select></div>
                                <div class="filter-action"><a href="blog-grid.html" class="active" title="Two Column"><i class="fas fa-th-large"></i></a><a href="blog-standard.html" title="One Column"><i class="fas fa-th-list"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="blog-card">
                                <div class="blog-media">
                                    <a class="blog-img" href="#"><img src={require('../../images/blog/05.jpg')} alt="blog"/></a>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                        <li><i class="fas fa-user"></i><span>admin</span></li>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="blog-card">
                                <div class="blog-media">
                                    <a class="blog-img" href="#"><img src={require('../../images/blog/06.jpg')} alt="blog"/></a>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                        <li><i class="fas fa-user"></i><span>admin</span></li>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="blog-card">
                                <div class="blog-media">
                                    <a class="blog-img" href="#"><img src={require('../../images/blog/07.jpg')} alt="blog"/></a>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                        <li><i class="fas fa-user"></i><span>admin</span></li>
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="blog-card">
                                <div class="blog-media">
                                    <a class="blog-img" href="#"><img src={require('../../images/blog/08.jpg')} alt="blog"/></a>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                        <li><i class="fas fa-user"></i><span>admin</span></li>
                ...
                <div class="col-md-7 col-lg-4">
                    ...
                    <div class="blog-widget">
                        ...
                        <ul class="blog-widget-feed">
                            <li>
                                <a class="blog-widget-media" href="#"><img src={require('../../images/blog-widget/01.jpg')} alt="blog-widget"/></a>
                                <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet consectetur</a><span>february 02, 2021</span></h6>
                            </li>
                            <li>
                                <a class="blog-widget-media" href="#"><img src={require('../../images/blog-widget/02.jpg')} alt="blog-widget"/></a>
                                <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet consectetur</a><span>february 02, 2021</span></h6>
                            </li>
                            <li>
                                <a class="blog-widget-media" href="#"><img src={require('../../images/blog-widget/03.jpg')} alt="blog-widget"/></a>
                                <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet consectetur</a><span>february 02, 2021</span></h6>
                            </li>
                            <li>
                                <a class="blog-widget-media" href="#"><img src={require('../../images/blog-widget/04.jpg')} alt="blog-widget"/></a>
                                <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet consectetur</a><span>february 02, 2021</span></h6>
                            </li>
                            <li>
                                <a class="blog-widget-media" href="#"><img src={require('../../images/blog-widget/05.jpg')} alt="blog-widget"/></a>
                                <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet consectetur</a><span>february 02, 2021</span></h6>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="blog-widget">
                        <a href="#"><img class="img-fluid" src={require('../../images/promo/blog/01.jpg')} alt="promo"/></a>
                    </div>
                </div>
            </div>
        </div>
