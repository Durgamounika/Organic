...
<section class="inner-section contact-part">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3654.3406974350205!2d90.48469931445422!3d23.663771197998262!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b0d5983f048d%3A0x754f30c82bcad3cd!2sJalkuri%20Bus%20Stop!5e0!3m2!1sen!2sbd!4v1605354966349!5m2!1sen!2sbd"
                ...
                <div class="col-lg-6">
                    <form class="contact-form">
                        ...
                        </div><button type="submit" class="form-btn-group"><i class="fas fa-envelope"></i><span>send message</span></button></form>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="branch-card"><img src={require('../../images/branch/01.jpg')} alt="branch"/>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="branch-card"><img src={require('../../images/branch/02.jpg')} alt="branch"/>
                        <div class="branch-overlay">
                            <h3>Narayanganj</h3>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="branch-card"><img src={require('../../images/branch/03.jpg')} alt="branch"/>
                        <div class="branch-overlay">
                            <h3>chandpur</h3>
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="branch-card"><img src={require('../../images/branch/04.jpg')} alt="branch"/>
                        <div class="branch-overlay">
                            <h3>noakhli</h3>
